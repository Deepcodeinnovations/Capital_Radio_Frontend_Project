<template>
  <div class="min-h-screen bg-gray-50">
    ...
    >
      ...
      >
        <div
          class="absolute top-1/4 left-1/4 w-64 h-64 bg-pink-500 rounded-full blur-3xl animate-gentle-float"
        ></div>
        <div
          class="absolute bottom-1/4 right-1/4 w-72 h-72 bg-purple-600 rounded-full blur-3xl animate-gentle-float-delayed"
        ></div>
        <div
          class="absolute top-1/2 right-1/3 w-48 h-48 bg-pink-400 rounded-full blur-3xl animate-gentle-float"
        ></div>
      </div>
      ...
      <div class="relative z-10 container mx-auto px-6 text-center">
        ...
        <!-- Subtitle -->
        <p
          class="text-xl md:text-2xl text-white/90 mb-8 max-w-4xl mx-auto leading-relaxed"
        >
          Stay updated with breaking news, entertainment updates, and exclusive
          stories from KIIS 100.9
        </p>
    ...
    <div class="relative overflow-hidden bg-white" id="news-content">
      ...
      <div class="absolute inset-0 opacity-5">
        <div
          class="absolute top-0 right-0 w-72 h-72 bg-pink-500 rounded-full blur-3xl"
        ></div>
        <div
          class="absolute bottom-0 left-0 w-96 h-96 bg-purple-600 rounded-full blur-3xl"
        ></div>
        <div
          class="absolute top-1/2 left-1/2 w-64 h-64 bg-pink-400 rounded-full blur-3xl"
        ></div>
      </div>
      ...
      <div class="container mx-auto px-4 md:px-6 relative z-20 py-20">
        ...
        <div class="text-center mb-16">
          ...
          >
            Get the latest news and updates from Uganda's premier entertainment
            and music hub
          </p>
        </div>
        ...
        <div class="mb-12">
          ...
          <div class="flex justify-center mb-6">
            ...
            >
              ...
              Filters & Categories
              <ChevronDown
                class="w-4 h-4 transition-transform text-pink-500"
          ...
          <div v-if="showFilters" class="relative">
            <div
              class="absolute -inset-0.5 bg-pink-500 rounded-3xl opacity-20 blur-sm"
            ></div>

            <div
              class="relative bg-white rounded-3xl p-6 mb-8 border-2 border-pink-200 max-w-4xl mx-auto"
            >
        ...
        <div v-else-if="news && news.data && news.data.length > 0">
          ...
          <div v-if="featuredNews.length > 0" class="mb-12">
            <div class="flex items-center gap-3 mb-8">
              <div
                class="w-10 h-10 bg-pink-100 rounded-2xl flex items-center justify-center"
              >
            ...
            <div class="grid grid-cols-1 lg:grid-cols-2 gap-6 mb-8">
              ...
              >
                <!-- Border Effect -->
                <div
                  class="absolute -inset-0.5 bg-pink-500 rounded-3xl opacity-0 group-hover:opacity-100 transition-opacity duration-500 blur-sm"
                ></div>

                <div
                  class="relative bg-white rounded-3xl overflow-hidden border-2 border-pink-100 hover:shadow-2xl hover:shadow-pink-500/20 transition-all duration-500 transform hover:scale-105"
                >
                  <div class="relative h-64 overflow-hidden">
                    ...
                    <div class="absolute top-4 left-4 flex gap-2">
                      <span
                        ...
                        class="inline-flex items-center px-3 py-1.5 rounded-full text-xs font-black bg-pink-500 text-white shadow-lg"
                      >
                      ...
                      <span
                        ...
                        class="inline-flex items-center px-3 py-1.5 rounded-full text-xs font-black bg-yellow-500 text-white shadow-lg"
                      >
                    ...
                    <div class="absolute bottom-4 left-4">
                      <span
                        class="bg-white/90 backdrop-blur-sm px-3 py-1.5 rounded-full text-xs font-black text-gray-800 border border-pink-200"
                      >
                  ...
                  <div class="p-6">
                    <h3
                      class="text-xl font-black text-gray-900 mb-3 group-hover:text-pink-500 transition-all duration-300 line-clamp-2"
                    >
                      {{ article.title }}
                    </h3>
                    ...
                    <div class="flex items-center justify-between">
                      ...
                      >
                        ...
                        >
                          <Clock class="w-4 h-4" />
                          <span class="font-semibold"
                            >{{ article.reading_time || 2 }}min</span
                          >
                        </div>
                      </div>
                    </div>
          ...
          <div class="space-y-6 mb-8">
            <div class="flex items-center gap-3 mb-8">
              <div
                class="w-10 h-10 bg-purple-100 rounded-2xl flex items-center justify-center"
              >
            ...
            >
              ...
              <div
                class="relative bg-white rounded-3xl p-6 border-2 border-pink-100 hover:shadow-2xl hover:shadow-pink-500/20 transition-all duration-500 transform hover:scale-[1.02] overflow-hidden"
              >
                <div class="flex items-start space-x-4">
                  <div class="flex-shrink-0">
                    <div
                      class="w-24 h-24 rounded-2xl overflow-hidden bg-pink-50"
                    >
                      <img
                        :src="article.featured_image_url"
                        :alt="article.title"
                  ...
                  <div class="flex-1 min-w-0">
                    <div class="flex flex-wrap items-center gap-3 mb-3">
                      <span
                        class="inline-flex items-center px-3 py-1.5 rounded-full text-xs font-black bg-gray-100 text-gray-800 border border-gray-200"
                      >
                        {{ article.category?.name || "News" }}
                      </span>
                      ...
                      <span
                        v-if="article.is_breaking"
                        class="inline-flex items-center px-3 py-1.5 rounded-full text-xs font-black bg-pink-100 text-pink-600 border border-pink-200"
                      >
                        <Zap class="w-3 h-3 mr-1" />
                        BREAKING
                      </span>
                      ...
                      <span
                        v-if="article.is_featured"
                        class="inline-flex items-center px-3 py-1.5 rounded-full text-xs font-black bg-yellow-100 text-yellow-600 border border-yellow-200"
                      >
                        <Star class="w-3 h-3 mr-1" />
                        FEATURED
                      </span>
                      ...
                      <span
                        class="text-xs text-gray-500 flex items-center gap-1 bg-gray-100 px-2 py-1 rounded-full"
                      >
                    ...
                    <h3
                      class="text-lg font-black text-gray-900 mb-2 group-hover:text-pink-500 transition-all duration-300 line-clamp-2"
                    >
                      {{ article.title }}
                    </h3>
        ...
        <div v-else class="text-center py-20">
          <div
            class="w-20 h-20 bg-pink-100 rounded-3xl flex items-center justify-center mx-auto mb-6"
          >
          ...
          <p class="text-gray-600 mb-6 leading-relaxed">
            {{
              searchQuery
                ...
                : "Check back later for the latest updates from KIIS 100.9."
            }}
          </p>
          <button
...
const featuredNews = computed(() => {
  ...
  return news.value.data.filter(
    (article) => article.is_featured || article.is_breaking
  );
});

<template>
  <div class="relative">
    ...
    >
      ...
      <div
        class="absolute inset-0 bg-black curved-bg"
        :class="{ 'opacity-80': isScrolled }"
      ></div>
      ...
      >
        ...
        >
          <div class="relative mb-2 group">
            ...
            >
              ...
              <!-- Shine Effect -->
              <div
                class="absolute inset-0 bg-white/40 rounded-full opacity-0 group-hover:opacity-100 transition-opacity duration-500 animate-shimmer"
              ></div>
            </div>
          </div>
        ...
        <div class="flex-1 flex justify-end">
          ...
          >
            <div
              class="absolute inset-0 bg-pink-400 opacity-0 group-hover:opacity-100 transition-opacity duration-500 rounded-2xl blur-sm -z-10"
            ></div>
    ...
    >
      <div
        v-if="isOpen"
        class="fixed inset-0 z-50 bg-black/95 backdrop-blur-2xl"
      >
        <!-- Background -->
        ...
        <div class="relative z-10 h-full flex items-center justify-center p-6">
          ...
          <div class="text-center max-w-4xl mx-auto w-full">
              ...
              <div class="flex items-center justify-center space-x-4 mb-6">
                <div class="w-16 h-16 relative">
                  <div class="absolute inset-0 bg-pink-500 rounded-full p-1">
                    <div
                      class="w-full h-full bg-white rounded-full flex items-center justify-center shadow-inner"
                    >
                ...
                >
                  <span class="text-pink-200"> KIIS 100.9 </span>
                </h2>
              </div>
            ...
            <nav class="mb-4">
              <div class="space-y-4">
                ...
                >
                  ...
                  <div
                    class="absolute bottom-0 left-1/2 transform -translate-x-1/2 w-0 group-hover:w-full h-0.5 bg-pink-500 transition-all duration-500"
                  ></div>
                </router-link>
              </div>
            </nav>
            ...
            <div class="mb-8">
              ...
              >
                <div
                  class="absolute inset-0 bg-white/10 transform -skew-x-12 -translate-x-full group-hover:translate-x-full transition-transform duration-1000"
                ></div>
                <div
            ...
            <div>
              <h6
                class="text-white/50 font-semibold mb-4 text-lg tracking-wide"
              >
                Connect With Us
              </h6>

<template>
  ...
  <div class="fixed right-4 md:right-6 bottom-4 md:bottom-6 z-50">
    ...
    >
      ...
      <div
        class="absolute -inset-1 bg-gradient-to-br from-pink-400 to-purple-500 rounded-3xl blur opacity-50 group-hover:opacity-75 transition duration-500"
      ></div>

      <!-- Live indicator -->
      <div
        class="absolute -top-1 -right-1 w-5 h-5 bg-gradient-to-br from-yellow-400 to-orange-500 rounded-full flex items-center justify-center animate-pulse shadow-lg shadow-yellow-400/50 border-2 border-white"
      >
      ...
      <div
        v-if="unreadCount > 0"
        class="absolute -top-2 -left-2 bg-gradient-to-br from-yellow-400 to-orange-500 text-purple-800 text-xs font-black rounded-full w-6 h-6 flex items-center justify-center animate-bounce border-2 border-white shadow-lg"
      >
      ...
      <!-- Enhanced Tooltip -->
      <div
        class="absolute bottom-full right-0 mb-3 px-4 py-3 bg-black/80 backdrop-blur-xl text-white text-xs rounded-2xl opacity-0 group-hover:opacity-100 transition-opacity duration-300 whitespace-nowrap pointer-events-none border border-pink-300/30"
      >
    ...
    <div
      v-if="!isExpanded && !isClosed"
      class="absolute bottom-full right-0 mb-5 w-[220px] bg-gradient-to-r from-pink-500 via-purple-500 to-pink-600 text-white text-xs font-bold px-4 py-3 rounded-2xl shadow-2xl shadow-pink-500/30 border border-pink-300/30"
    >
      <div class="relative">
        <!-- Close button -->
        <button
          @click="isClosed = true"
          class="absolute -top-2 -right-2 bg-white text-pink-600 rounded-full p-1 shadow hover:bg-gray-100 transition"
        >
          ✕
        </button>
        ...
        <div
          class="absolute -bottom-2 right-6 w-0 h-0 border-l-4 border-r-4 border-t-4 border-transparent border-t-pink-500"
        ></div>
      </div>
    </div>
    ...
    >
      ...
      <div
        class="relative px-4 md:px-6 py-4 bg-gradient-to-r from-pink-500 via-purple-500 to-pink-600 border-b-2 border-pink-400/30"
      >
        <!-- Gradient overlay effect -->
        <div
          class="absolute inset-0 bg-gradient-to-r from-pink-400/20 to-purple-400/20"
        ></div>
        ...
        <div class="relative flex items-center justify-between">
          <div class="flex items-center gap-3">
            ...
            <div class="relative">
              <div
                class="w-3 h-3 bg-gradient-to-br from-yellow-400 to-orange-500 rounded-full animate-pulse shadow-lg shadow-yellow-400/50"
              ></div>
              <div
                class="absolute inset-0 w-3 h-3 bg-yellow-400 rounded-full animate-ping opacity-40"
              ></div>
            </div>

            <div>
              <h3 class="font-black text-lg text-white uppercase tracking-wide">
                LIVE CHAT
              </h3>
          ...
          <div class="flex items-center gap-2">
            <!-- Online counter -->
            <div
              class="bg-gradient-to-r from-yellow-400 to-orange-500 text-purple-800 text-xs px-3 py-1.5 rounded-full font-black uppercase tracking-wider flex items-center gap-1 shadow-lg"
            >
      ...
      <div
        ref="chatContainer"
        class="flex-1 overflow-y-auto p-3 md:p-4 space-y-3 bg-gradient-to-b from-white to-pink-50/30 scrollbar-thin scrollbar-thumb-pink-400 scrollbar-track-pink-100"
      ...
      >
        ...
        <div v-if="!messages || messages.length === 0" class="text-center py-8">
          ...
          <p class="text-gray-600 text-sm font-semibold">
            Welcome to KIIS 100.9 Live Chat!
          </p>
        ...
        >
          ...
          <div v-if="message.type === 'system'" class="relative inline-block">
            <div
              class="text-xs text-purple-700 bg-gradient-to-r from-pink-100 via-purple-50 to-pink-100 rounded-full px-4 py-2 border border-pink-200 font-bold uppercase tracking-wide shadow-sm"
            >
          ...
          >
            ...
            >
              <div
                class="w-8 h-8 rounded-2xl overflow-hidden flex-shrink-0 shadow-lg border-2 border-pink-200 group-hover:border-pink-400 transition-all duration-300"
              >
                <img
                ...
                <div
                  v-else
                  class="w-full h-full flex items-center justify-center bg-gradient-to-br from-pink-500 to-purple-600 text-white font-black text-xs uppercase"
                >
              ...
              <!-- Online indicator -->
              <div
                class="absolute -bottom-1 -right-1 w-2.5 h-2.5 bg-gradient-to-br from-yellow-400 to-orange-500 rounded-full border-2 border-white animate-pulse shadow-sm"
            ...
            <div class="relative max-w-[75%] group/message">
              ...
              <div
                v-if="message.user.id !== currentUser.id"
                class="absolute top-3 -left-1 w-3 h-3 bg-white transform rotate-45 border-l-2 border-b-2 border-pink-200/50"
              ></div>
              <div
                v-else
                class="absolute top-3 -right-1 w-3 h-3 bg-gradient-to-r from-pink-100 to-purple-100 transform rotate-45 border-r-2 border-t-2 border-pink-300"
              ></div>
            </div>
            ...
            >
              <div
                class="w-8 h-8 rounded-2xl overflow-hidden flex-shrink-0 shadow-lg border-2 border-yellow-300 group-hover:border-yellow-400 transition-all duration-300"
              >
                <img
                ...
                <div
                  v-else
                  class="w-full h-full flex items-center justify-center bg-gradient-to-br from-yellow-400 to-orange-500 text-purple-700 font-black text-xs uppercase"
                >
              ...
              <!-- You indicator -->
              <div
                class="absolute -bottom-1 -right-1 w-2.5 h-2.5 bg-gradient-to-br from-pink-500 to-purple-600 rounded-full border-2 border-white shadow-sm"
                title="You"
              ></div>
            </div>
          </div>
        ...
        >
          <div
            class="w-6 h-6 rounded-2xl overflow-hidden flex-shrink-0 shadow-md border-2 border-pink-200"
          >
            <div
              class="w-full h-full flex items-center justify-center bg-gradient-to-br from-pink-500 to-purple-600 text-white font-black text-xs"
            >
              DJ
            </div>
          </div>
          <div class="flex items-center gap-2">
            ...
            <div class="flex gap-1">
              ...
              ></span>
              <span
                class="w-1 h-1 bg-purple-500 rounded-full animate-bounce"
                style="animation-delay: 0.2s"
              ></span>
              <span
                class="w-1 h-1 bg-pink-400 rounded-full animate-bounce"
      ...
      <!-- Chat input -->
      <div
        class="relative p-3 md:p-4 border-t-2 border-pink-200 bg-gradient-to-r from-pink-50/50 to-purple-50/50 backdrop-blur-sm"
      >
        <div class="relative flex gap-2">
          ...
          <div class="flex-1 relative group">
            ...
            />
            <div
              class="absolute right-3 top-1/2 transform -translate-y-1/2 text-pink-400 group-hover:text-pink-600 transition-colors"
            >
          ...
          >
            <!-- Gradient glow effect -->
            <div
              class="absolute -inset-0.5 bg-gradient-to-r from-pink-400 to-purple-500 rounded-2xl blur opacity-0 group-hover:opacity-50 transition duration-300"
            ></div>
            <Send
        ...
        <div
          ...
          class="absolute bottom-full left-4 right-4 mb-2 bg-white/95 backdrop-blur-xl rounded-2xl border-2 border-pink-200 shadow-2xl shadow-pink-500/20 p-4 max-h-40 overflow-y-auto"
        >
        ...
        <div class="mt-2 flex items-center gap-2 px-1">
          ...
          <span class="text-xs text-gray-600 font-medium">
            <span v-if="!canSendMessage" class="text-pink-600 font-bold"
    ...
    >
      <div
        class="relative bg-white/95 backdrop-blur-xl rounded-3xl p-6 w-full max-w-sm mx-4 border-2 border-pink-300 shadow-2xl shadow-pink-500/20"
      >
        <!-- Gradient border effect -->
        <div
          class="absolute -inset-0.5 bg-gradient-to-br from-pink-400 to-purple-500 rounded-3xl opacity-20 blur-sm"
        ></div>

        <div class="relative">
          <div class="text-center mb-6">
            <div
              class="w-16 h-16 mx-auto mb-4 bg-gradient-to-br from-pink-500 to-purple-600 rounded-3xl flex items-center justify-center shadow-lg"
            >
              <MessageCircle class="h-8 w-8 text-white" />
            </div>
            <h3
              class="text-xl font-black bg-gradient-to-r from-pink-500 to-purple-600 bg-clip-text text-transparent mb-2 uppercase tracking-wide"
            >
              JOIN THE CHAT 💬
            </h3>
          ...
          <div class="space-y-4">
            <div>
              <label
                class="block text-sm font-black text-pink-600 mb-2 uppercase tracking-wider"
                >FULL NAME</label
              >
              <input
            ...
            <div>
              ...
              <div
                v-if="emailError"
                class="text-pink-600 text-xs mt-2 font-bold"
              >
                {{ emailError }}
              </div>
            </div>
            ...
            <div class="flex gap-3 pt-4">
              ...
              >
                <div
                  class="absolute -inset-0.5 bg-gradient-to-r from-pink-400 to-purple-500 rounded-2xl blur opacity-60 group-hover:opacity-100 transition duration-300"
                ></div>
                <div

<template>
  <section
    class="relative min-h-screen overflow-hidden bg-gradient-to-br from-gray-900 via-purple-900 to-pink-900"
    ref="sectionRef"
  >
    <!-- Top Fade to White -->
    <div
      class="absolute top-0 left-0 w-full h-32 bg-gradient-to-b from-white via-white/50 to-transparent z-5"
    ></div>
    ...
    <div class="absolute inset-0 z-0">
      <div class="w-full h-full relative">
        <img
          src="https://images.unsplash.com/photo-1659894927229-34c07a05de7e?w=1500&auto=format&fit=crop&q=60&ixlib=rb-4.1.0&ixid=M3wxMjA3fDB8MHxzZWFyY2h8MjIzfHxiZWF0JTJDJTIwbXVzaWN8ZW58MHx8MHx8fDA%3D"
          alt="Radio Studio Background"
          class="w-full h-full object-cover"
        />
        <div
          class="absolute inset-0 bg-gradient-to-br from-black/70 via-purple-900/60 to-pink-900/70"
        ></div>
        <div
    ...
    >
      <div
        class="absolute top-1/4 left-1/4 w-32 h-32 bg-gradient-to-br from-pink-500 to-purple-600 rounded-full blur-3xl animate-gentle-float"
      ></div>
      <div
        class="absolute bottom-1/3 right-1/4 w-40 h-40 bg-gradient-to-br from-purple-500 to-pink-500 rounded-full blur-3xl animate-gentle-float-delayed"
      ></div>
      ...
      <div class="mx-auto px-4">
        ...
        >
          <div class="inline-flex items-center justify-center mb-6">
            ...
            ></span>
            <span
              class="mx-4 text-transparent bg-gradient-to-r from-pink-400 to-purple-400 bg-clip-text font-bold tracking-wider text-sm uppercase"
              >Our Team</span
            >
            <span
          ...
          <h2
            class="text-3xl md:text-4xl lg:text-5xl font-black text-white mb-6"
          >
            Meet Our
            <span
          ...
          <p
            class="text-white/90 text-lg md:text-xl max-w-3xl mx-auto leading-relaxed"
          >
            The voices that bring KIIS 100.9 to life, entertaining and informing
            Uganda every day
          </p>
        </div>
        ...
        <div v-if="isLoading" class="container mx-auto">
          <div
            class="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-4 gap-6 px-4"
          >
            <div v-for="i in 4" :key="i" class="animate-pulse">
              <div
                class="bg-gradient-to-br from-pink-200/20 to-purple-200/20 rounded-3xl h-96 backdrop-blur-sm"
              ></div>
            </div>
          </div>
        </div>
        ...
        >
          <div
            class="w-20 h-20 bg-gradient-to-br from-pink-500/20 to-purple-500/20 backdrop-blur-sm rounded-3xl flex items-center justify-center mx-auto mb-6 border border-pink-400/30"
          >
                ...
                >
                  ...
                  >
                    ...
                    >
                      ...
                      <div
                        class="absolute -inset-1 bg-gradient-to-br from-pink-500 via-purple-500 to-pink-500 rounded-3xl blur opacity-0 group-hover:opacity-90 transition duration-500"
                      ></div>
                      ...
                      >
                        ...
                        <div class="aspect-[8/5] overflow-hidden relative">
                          ...
                          <div
                            ...
                            class="absolute top-4 left-4 flex items-center space-x-2 bg-gradient-to-r from-pink-500 to-purple-600 backdrop-blur-sm rounded-full px-3 py-1.5 shadow-lg"
                          >
                            <div
                              class="w-2 h-2 bg-white rounded-full animate-pulse"
                            ></div>
                            <span
                              class="text-white text-xs font-black tracking-wide"
                              >ON AIR</span
                            >
                          </div>
                          ...
                          <!-- Experience Badge -->
                          <div
                            class="absolute top-4 right-4 bg-gradient-to-r from-yellow-400 to-orange-500 backdrop-blur-sm rounded-full px-3 py-1.5 shadow-lg"
                          >
                            <span class="text-black text-xs font-black"
                          ...
                          <!-- Hover Overlay -->
                          <div
                            class="absolute inset-0 flex items-center justify-center opacity-0 group-hover:opacity-100 transition-opacity duration-300 bg-gradient-to-t from-black/70 via-purple-900/50 to-pink-900/30"
                          >
                            <div class="text-center">
                              <div
                                class="w-16 h-16 bg-gradient-to-br from-pink-400/30 to-purple-500/30 backdrop-blur-sm rounded-full flex items-center justify-center mx-auto mb-3 border border-pink-300/50"
                              >
                        ...
                        <div class="p-6">
                          <div class="mb-4">
                            <h3
                              class="text-lg font-black text-white mb-2 group-hover:bg-gradient-to-r group-hover:bg-clip-text transition-all duration-300"
                            >
                              {{ host.name }}
                            </h3>
                            <p class="text-pink-300 text-sm font-bold mb-2">
                              {{ host.role }}
                            </p>
                            ...
                            >
                              <p
                                class="text-white/70 text-sm mb-2 font-semibold"
                              >
                                Shows:
                              </p>
                          ...
                          >
                            {{
                              host.bio ||
                              "Experienced radio presenter bringing entertainment and quality content to KIIS 100.9 listeners."
                            }}
                          </p>
                          ...
                          >
                            <div
                              class="absolute -inset-0.5 bg-gradient-to-r from-pink-500 to-purple-600 rounded-2xl opacity-60 group-hover/btn:opacity-100 transition duration-300 blur-sm"
                            ></div>
                            <div
                              class="relative bg-gradient-to-r from-pink-500/80 to-purple-600/80 backdrop-blur-sm py-3 px-4 rounded-2xl text-white font-bold hover:from-pink-500 hover:to-purple-600 transition-all duration-300 border border-pink-300/30"
                            >
                              View Profile
                            </div>
                          </button>
    ...
    >
      <div
        class="relative bg-black/80 backdrop-blur-xl border border-pink-300/30 rounded-3xl p-8 max-w-4xl w-full max-h-[80vh] overflow-y-auto shadow-2xl"
        @click.stop
      >
        ...
        <div class="relative">
          <div class="flex items-center justify-between mb-6">
            <h3
              class="text-2xl font-black bg-gradient-to-r from-pink-400 to-purple-400 bg-clip-text text-transparent"
            >
              {{ selectedHost.name }}
            </h3>
            <button
              @click="closeHostDetails"
              class="text-white/60 hover:text-pink-400 transition-colors duration-300 p-2"
            >
              <X class="h-6 w-6" />
            </button>
          </div>
          ...
          <div class="grid grid-cols-1 md:grid-cols-2 gap-8">
            ...
            <div>
              <div class="mb-4">
                <span
                  class="bg-gradient-to-r from-pink-500/20 to-purple-500/20 text-pink-300 px-4 py-2 rounded-full text-sm font-black border border-pink-300/30 backdrop-blur-sm"
                >
                  {{ selectedHost.role }}
                </span>
              </div>
              ...
              >
                ...
                <div
                  class="h-[200px] overflow-y-auto space-y-3 pr-2 custom-scrollbar"
                >
                  <div
    ...
    <div class="absolute bottom-0 left-0 w-full overflow-hidden z-10">
      ...
      >
        ...
        />
        <path
          d="M0,60 C300,10 500,90 800,40 C900,20 1100,80 1200,45 L1200,100 L0,100 Z"
          fill="url(#bottomWave2)"
          opacity="0.3"
        />
        <path
          d="M0,70 C250,30 450,100 700,55 C850,35 1050,95 1200,65 L1200,100 L0,100 Z"
          fill="white"
        />

      ...
      <div class="relative z-10 container mx-auto px-6 text-center">
        ...
        <!-- <div class="grid grid-cols-2 md:grid-cols-4 gap-8 mb-12 max-w-4xl mx-auto">
          <div class="text-center">
            <div class="text-3xl md:text-4xl font-bold text-pink-500 mb-2">{{ eventStats.upcoming_events }}</div>
            <div class="text-sm text-gray-300 uppercase tracking-wide">Upcoming Events</div>
          </div>
          <div class="text-center">
            <div class="text-3xl md:text-4xl font-bold text-purple-600 mb-2">{{ eventStats.this_month }}</div>
            <div class="text-sm text-gray-300 uppercase tracking-wide">This Month</div>
          </div>
          <div class="text-center">
            <div class="text-3xl md:text-4xl font-bold text-pink-500 mb-2">{{ events?.total || 0 }}</div>
          ...
          <div class="text-center">
            <div class="text-3xl md:text-4xl font-bold text-purple-600 mb-2 flex items-center justify-center gap-2">
              ...
              <div v-if="eventStats.featured_events > 0" class="w-3 h-3 bg-pink-500 rounded-full animate-pulse"></div>
            </div>
          ...
          >
            ...
            <div class="relative">
              ...
              <input
                ...
                @change="filterByDate"
                type="date"
                class="w-full pl-12 pr-4 py-4 bg-white border-2 border-purple-200 rounded-xl text-gray-900 focus:outline-none focus:ring-2 focus:ring-purple-600 focus:border-purple-600 shadow-sm"
              />
            </div>

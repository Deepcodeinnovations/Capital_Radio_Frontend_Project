<template>
  <!-- Hero Section -->
  <section class="relative min-h-screen flex items-center justify-center overflow-hidden backgroundFixed"  style=" background-image: url('https://images.unsplash.com/photo-1598488035139-bdbb2231ce04?ixlib=rb-4.0.3&auto=format&fit=crop&w=2000&q=80')" >
    ...
    <div class="relative z-10 container mx-auto px-6 text-center">
      ...
      <div class="inline-flex items-center justify-center mb-8">
        ...
        <span class="mx-4 text-pink-400 font-bold tracking-wider text-sm uppercase">Our Story</span>
        <div class="h-px w-12 bg-pink-500"></div>
      </div>
      ...
      <p class="text-xl md:text-2xl text-gray-200 mb-8 max-w-4xl mx-auto leading-relaxed">
        Uganda's hottest music station, delivering fresh hits and quality entertainment since 2020
      </p>

      <!-- Stats Row -->
      <div class="grid grid-cols-2 md:grid-cols-4 gap-8 mb-12 max-w-4xl mx-auto">
        <div class="text-center">
          <div class="text-3xl md:text-4xl font-bold text-pink-500 mb-2">4+</div>
          <div class="text-sm text-gray-300 uppercase tracking-wide">Years On Air</div>
        </div>
        <div class="text-center">
          <div class="text-3xl md:text-4xl font-bold text-purple-600 mb-2">500K+</div>
          <div class="text-sm text-gray-300 uppercase tracking-wide">Daily Listeners</div>
        </div>
        <div class="text-center">
          <div class="text-3xl md:text-4xl font-bold text-pink-500 mb-2">100.9</div>
      ...
      <div class="flex flex-col sm:flex-row gap-4 justify-center items-center">
        ...
        <button @click="scrollToShows" class="bg-white/10 backdrop-blur-md border-2 border-white/20 text-white font-semibold px-8 py-4 rounded-2xl hover:bg-white/20 transition-all duration-300">

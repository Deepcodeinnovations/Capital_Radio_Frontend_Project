<template>
  <!-- Hero Section -->
  <section
    class="relative min-h-screen flex items-center justify-center overflow-hidden backgroundFixed"
    style="
      background-image: url('https://images.unsplash.com/photo-1598488035139-bdbb2231ce04?ixlib=rb-4.0.3&auto=format&fit=crop&w=2000&q=80');
    "
  >
    ...
    <div class="relative z-10 container mx-auto px-6 text-center">
      ...
      >
        Uganda's hottest music station, delivering fresh hits and quality
      ...
      <div class="flex flex-col sm:flex-row gap-4 justify-center items-center">
        ...
        <button
          @click="scrollToShows"
          class="bg-white/10 backdrop-blur-md border-2 border-white/20 text-black sm:text-white font-semibold px-8 py-4 rounded-2xl hover:bg-white/20 transition-all duration-300"
        >
    ...
    >
      <div class="flex flex-col items-center text-white/60">
        ...
        >
          <div
            class="w-1 h-3 bg-white/60 rounded-full animate-bounce mt-2"
          ></div>
        </div>
      </div>
    </div>

  ...
  <div class="min-h-screen bg-gray-50">
    ...
    >
      ...
      <div class="relative z-10 container mx-auto px-6 text-center">
        ...
        >
          Listen to recorded radio programs from KIIS 100.9 - Uganda's hottest
          music station
        </p>
        ...
        >
          <div class="text-center">
            <div class="text-3xl md:text-4xl font-black text-pink-500 mb-2">
              {{ sessionRecordings?.total || 0 }}
            </div>
            <div
              class="text-sm text-white/80 uppercase tracking-wide font-semibold"
            >
              Total Episodes
            </div>
          </div>
          <div class="text-center">
            <div class="text-3xl md:text-4xl font-black text-purple-600 mb-2">
          ...
          <div class="text-center">
            <div
              class="text-3xl md:text-4xl font-black text-purple-600 mb-2 flex items-center justify-center gap-2"
            >
              {{ todayEpisodes }}
              <div
                v-if="todayEpisodes > 0"
                class="w-3 h-3 bg-pink-500 rounded-full animate-pulse"
              ></div>
            </div>
            <div
              class="text-sm text-white/80 uppercase tracking-wide font-semibold"
    ...
    <div class="relative overflow-hidden bg-white" id="shows-content">
      ...
      <div class="container mx-auto px-4 md:px-6 relative z-20 py-20">
        ...
        <div class="text-center mb-16">
          ...
          >
            Catch up on your favorite KIIS 100.9 programs with our extensive
            ...
            <button
              ...
              :class="
                quickFilter === 'today'
                  ...
                  : 'bg-white hover:bg-gray-50 text-gray-700 border-2 border-pink-200'
              "
              ...
              >
                <div class="flex items-start space-x-4">
                  <div class="flex-shrink-0">
                    <div
                      class="w-24 h-24 rounded-2xl overflow-hidden relative group/play bg-pink-50"
                    >
                      <img
                        :src="
                  ...
                  <div class="flex-1 min-w-0">
                    <div class="flex flex-wrap items-center gap-3 mb-3">
                      ...
                      <span
                        ...
                        class="text-xs px-3 py-1 bg-green-100 text-green-700 rounded-full font-bold border border-green-200"
                      >
                        Available
                      </span>
                      <span
                        v-else
                        class="text-xs px-3 py-1 bg-yellow-100 text-yellow-700 rounded-full font-bold border border-yellow-200"
                      >
                    ...
                    <h3
                      class="text-lg font-black text-gray-900 mb-2 group-hover:text-pink-500 transition-all duration-300"
                    >
                      {{ show.program?.title }} -
                      {{ formatShowDate(show.session_date) }}
                    </h3>
                      ...
                      <div class="flex items-center space-x-2">
                        <div class="flex -space-x-1">
                          ...
                          >
                            ...
                            <span
                              v-else
                              class="text-xs font-bold text-pink-600"
                ...
                <div
                  ...
                  class="mt-6 pt-6 border-t border-pink-200"
                >
                  <div class="flex items-center space-x-4">
                    ...
                    <div class="flex-1">
                      <div
                        class="flex items-center justify-between text-xs text-gray-500 mb-1 font-semibold"
                      >

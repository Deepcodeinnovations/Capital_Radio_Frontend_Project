    ...
    <div class="container mx-auto px-6 relative">
      ...
      <div class="text-center mb-16">
        <div class="inline-flex items-center justify-center mb-6">
          ...
          <span class="mx-4 text-black font-bold tracking-wider text-sm uppercase">Community</span>
          <div class="h-px w-12 bg-red-600"></div>
        </div>
        <h2 class="text-4xl md:text-5xl font-bold text-black mb-6">
          Join Our Community <span class="text-red-600">Discussions</span>
        </h2>
        <p class="text-xl text-gray-700 max-w-3xl mx-auto leading-relaxed">
          Connect with fellow Beat FM listeners, share your thoughts, and be part of Uganda's most vibrant music community
        </p>
      </div>
      
      <!-- Main Forum Card -->
      <div class="bg-white  border border-gray-200 overflow-hidden mb-12">
        <div class="grid grid-cols-1 lg:grid-cols-3">
          ...
          <div class="bg-gray-50 p-8 lg:p-10 relative">
            <div class="text-center mb-8">
              ...
              <h3 class="text-2xl font-bold text-black mb-2">Community Stats</h3>
            ...
            <div v-else class="grid grid-cols-2 gap-4 mb-8">
              <div class="text-center p-4 bg-white  border border-gray-200 hover:border-red-600/50 transition-all group transform hover:scale-105">
                <div class="text-2xl font-bold text-red-600 mb-1 group-hover:animate-pulse">
              ...
              <div class="text-center p-4 bg-white  border border-gray-200 hover:border-black/50 transition-all group transform hover:scale-105">
                <div class="text-2xl font-bold text-black mb-1 group-hover:animate-pulse">
            ...
            <button 
              ...
              class="w-full bg-red-600 hover:bg-red-700 text-white font-bold px-6 py-3  flex items-center justify-center space-x-2 transition-all duration-300 transform hover:scale-105"
            >
          ...
          <div class="lg:col-span-2 p-8 lg:p-10">
            <div class="flex items-center justify-between mb-8">
              <div>
                <h3 class="text-2xl font-bold text-black mb-2">Hot Discussions</h3>
              ...
              <div class="flex items-center space-x-2">
                <button 
                  ...
                  class="p-2 rounded-lg hover:bg-red-50 hover:text-red-600 text-gray-600 disabled:opacity-50 disabled:cursor-not-allowed transition-colors"
                >
                ...
                <button 
                  @click="navigateToForums"
                  class="flex items-center space-x-2 text-red-600 hover:text-black font-medium ml-4 transition-colors"
                >
                  <span>View All</span>
            ...
            <div v-else-if="hotTopics.length > 0" class="space-y-4">
              <div 
                ...
                :key="topic.id"
                class="group p-6 bg-gray-50 border border-gray-200 hover:border-red-600/50 transition-all cursor-pointer transform hover:scale-[1.02]"
              ...
              >
                ...
                <h4 class="text-lg font-semibold text-black mb-3 group-hover:text-red-600 transition-colors line-clamp-2">
                  {{ topic.title }}
                </h4>
                ...
                <div class="flex items-center justify-between">
                  ...
                  <div class="text-right">
                    <p class="text-sm text-black">{{ formatDate(topic.created_at) }}</p>
                    <p class="text-xs text-gray-500">
            ...
            <div v-else class="text-center py-12">
              ...
              <h3 class="text-lg font-medium text-black mb-2">No Hot Discussions Yet</h3>
            ...
            <div class="mt-8 pt-6 border-t border-gray-200">
              <button 
                @click="navigateToForums"
                class="w-full bg-gray-100 hover:bg-gray-200 text-black font-medium py-3 px-6 transition-all transform hover:scale-105"
              >
...
const communityEvents = ref([
  {
    day: '18',
    month: 'Jun',
    title: 'AMA with Beat FM Hosts',
    description: 'Join us for a live Q&A session with your favorite Beat FM hosts',
...
const getCategoryStyle = (category) => {
  const styles = {
    ...
    'TECHNOLOGY': 'bg-red-600/20 text-red-600',

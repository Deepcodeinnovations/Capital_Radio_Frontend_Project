...
export default [
  {
    path: '/maintanance',
    name: 'maintanance',
    component: () => import('@/views/maintanance_page.vue'),
    meta: {
      title: 'Maintanance',
      description: 'Maintanance and updates from Capital Radio',
      keywords: 'capital radio, maintanance, updates, capital fm',
      ogTitle: 'Capital Radio - Maintanance',
      ogDescription: 'Maintanance and updates from Capital Radio',
    },
  },
    {
      path: '/',

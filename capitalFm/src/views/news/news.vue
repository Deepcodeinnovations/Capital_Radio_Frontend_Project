<template>
  <div class="min-h-screen bg-gray-50">
    ...
    <div class="bg-white relative" id="news-content">
      ...
      >
        <div
          class="absolute top-1/4 left-1/5 w-32 h-32 bg-red-500 rounded-full blur-2xl animate-float"
        ></div>
        <div
          class="absolute bottom-1/3 right-1/5 w-40 h-40 bg-yellow-500 rounded-full blur-3xl animate-float"
      ...
      <div class="max-w-7xl mx-auto px-6 py-12 relative z-10">
        ...
        <div class="mb-12">
          ...
          <div
            v-if="showFilters"
            class="bg-gray-50 rounded-xl p-6 mb-8 border border-gray-200 max-w-4xl mx-auto"
          >
        ...
        <div v-if="isLoading" class="flex justify-center items-center py-20">
          <div
            class="w-12 h-12 border-4 border-gray-300 border-t-red-600 rounded-full animate-spin"
          ></div>
        </div>
        ...
        <div v-else-if="news && news.data && news.data.length > 0">
          ...
          <div v-if="featuredNews.length > 0" class="mb-12">
            <div class="flex items-center gap-3 mb-8">
              ...
              <div
                class="flex-1 h-px bg-gradient-to-r from-red-500 to-transparent"
              ></div>
            </div>
            ...
            <div class="grid grid-cols-1 lg:grid-cols-2 gap-6 mb-8">
              ...
              >
                ...
                <div
                  class="absolute -inset-1 bg-gradient-to-r from-red-500 via-yellow-500 to-blue-500 rounded-xl blur opacity-0 group-hover:opacity-10 transition duration-300"
                ></div>
                ...
                <div class="relative">
                  <div class="relative h-64 overflow-hidden">
                    ...
                    <div class="absolute bottom-4 left-4">
                      <span
                        class="bg-white/90 backdrop-blur-sm px-3 py-1 rounded-full text-xs font-medium text-gray-800"
                      >
          ...
          <div class="space-y-4 mb-8">
            ...
            >
              <!-- Gradient background on hover -->
              <div
                class="absolute -inset-1 bg-gradient-to-r from-red-500 via-yellow-500 to-blue-500 rounded-xl blur opacity-0 group-hover:opacity-5 transition duration-300"
              ></div>
              ...
              <div class="relative">
                <div class="flex items-start space-x-4">
                  ...
                  <div class="flex-1 min-w-0">
                    ...
                    <h3
                      class="text-lg font-semibold text-gray-900 mb-2 group-hover:text-red-600 transition-colors line-clamp-2"
                    >
                      {{ article.title }}
                    </h3>

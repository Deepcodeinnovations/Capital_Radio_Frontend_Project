      ...
      <div class="ticker-wrapper">
        <div class="ticker-content">
          <p class="text-white font-bold animate-ticker whitespace-nowrap">
            BREAKING NEWS: Capital FM launches new interactive website •
            Uganda's music scene explodes with new talent • Upcoming festival
            season announced • Exclusive interviews with top artists coming soon
            • New music releases this Friday
          </p>
        </div>
      </div>
    </div>

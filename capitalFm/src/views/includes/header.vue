<template>
  <div>
        ...
        <div class="flex items-center justify-between h-16 md:h-20">
          ...
          <div class="flex items-center space-x-2 md:space-x-3 pt-6 md:pt-8">
            ...
            <button
              ...
              :disabled="isLoading"
              class="relative group overflow-hidden rounded-2xl hidden lg:block"
            >
              <div
    ...
    <div v-if="isOpen" class="fixed inset-0 z-50 bg-black/95 backdrop-blur-xl">
      <div
        class="container mx-auto px-4 md:px-6 h-full flex items-center justify-center"
      >
        <button
          @click="toggleMenu"
        ...
        <div class="text-center max-w-4xl mx-auto">
          <div class="mb-8 md:mb-12">
            <div class="flex items-center justify-center space-x-3 mb-4">
              <div
                class="w-12 h-12 bg-gradient-to-br from-yellow-400 to-red-500 flex items-center justify-center"
              >
          ...
          <div class="mb-8 md:mb-12">
            ...
            >
              <div
                v-if="isLoading"
                class="w-6 h-6 border-2 border-white border-t-transparent animate-spin"
              ></div>
              <Volume2
                v-else-if="isPlaying"
                :size="24"
          ...
          <div>
            <h6
              class="text-white/60 font-semibold mb-4 md:mb-6 text-base md:text-lg"
            >
              Follow Us
            </h6>

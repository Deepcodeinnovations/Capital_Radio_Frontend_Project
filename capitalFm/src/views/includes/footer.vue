<template>
  <footer
    class="bg-gradient-to-br from-gray-900 via-black to-gray-900 text-white relative overflow-hidden"
  >
    <!-- Background Elements -->
    <div class="absolute inset-0 opacity-10">
      <div
        class="absolute top-20 left-20 w-64 h-64 bg-[#F8CB00] rounded-full blur-3xl animate-pulse"
      ></div>
      <div
      ...
      ></div>
      <div
        class="absolute top-1/2 left-1/2 w-48 h-48 bg-blue-500 rounded-full blur-3xl animate-pulse"
    ...
    <div class="relative z-10 pt-24 pb-12">
      <div class="container mx-auto px-6">
        ...
        >
          ...
          <div class="lg:col-span-1">
            ...
            <p class="text-gray-300 mb-6 leading-relaxed">
              Uganda's premier radio station delivering fresh hits, breaking
              news, and quality entertainment since 1993. Connecting communities
              across the nation.
            </p>
            ...
            <div class="flex space-x-4">
              ...
              >
                <div
                  class="absolute -inset-2 bg-gradient-to-r from-[#F8CB00] to-red-500 rounded-full blur opacity-0 group-hover:opacity-60 transition duration-300"
                ></div>
                <div
                  class="relative w-10 h-10 bg-gray-800 rounded-full flex items-center justify-center hover:bg-gray-700 transition-colors"
                >
          ...
          <div>
            ...
            <div class="space-y-4">
              <div class="flex items-start space-x-3">
                <div
                  class="w-10 h-10 bg-[#F8CB00]/20 rounded-full flex items-center justify-center flex-shrink-0 mt-1"
                >
                ...
                <div>
                  ...
                  <p class="text-gray-300 text-sm">
                    Plot 1A, Cooper Road<br />Kisementi, Kampala, Uganda
                  </p>
                </div>
              </div>
                ...
                <div>
                  ...
                  <p class="text-gray-300 text-sm">
                    <a
                      ...
                      class="hover:text-[#F8CB00] transition-colors"
                    >
                      Hotline: +256 414 215 100 </a
                    ><br />
                    <strong>WhatsApp: +256 752 333 998</strong>
                    <br />
                    <strong>Studio</strong>
                    <li
                      v-for="line in studioLines"
                      :key="line"
                      :href="'tel:' + line"
                      class="hover:text-[#F8CB00] transition-colors"
                    >
              ...
              <div class="flex items-start space-x-3">
                <div
                  class="w-10 h-10 bg-blue-500/20 rounded-full flex items-center justify-center flex-shrink-0 mt-1"
                >
                ...
                <div>
                  ...
                  <p class="text-gray-300 text-sm">
                    <a
                      href="mailto:info@capitalfm.co.ug"
                      class="hover:text-[#F8CB00] transition-colors"
                    >
                      bright@capitalfm-ug.com </a
                    ><br />
                  </p>
                </div>
              </div>
          ...
          <div>
            ...
            <div class="grid grid-cols-2 gap-3 mb-8">
              ...
              >
                <div
                  class="text-lg font-bold text-[#F8CB00] group-hover:scale-110 transition-transform"
                >
                  {{ freq.freq }}
                </div>
            ...
            >
              ...
              <p class="text-gray-300 text-sm mb-4">
                Get the latest news, show updates, and exclusive content.
              </p>
        ...
        <!-- Live Status Bar -->
        <div
          class="bg-gradient-to-r from-red-500/20 via-[#F8CB00]/20 to-blue-500/20 rounded-2xl p-6 mb-12 border border-gray-700/30"
        >
          <div
        ...
        <div class="border-t border-gray-700/50 pt-8">
          ...
          >
            <div class="text-gray-400 text-sm text-center md:text-left">
              <p>
                &copy; {{ currentYear }} Capital FM Uganda. All rights reserved.
              </p>
            ...
            >
              <a
                href="#"
                class="text-gray-400 hover:text-[#F8CB00] transition-colors"
                >Privacy Policy</a
              >
              <a
                href="#"
    ...
    <!-- Floating Elements -->
    <div
      class="absolute top-1/4 left-10 w-2 h-2 bg-[#F8CB00] rounded-full animate-ping opacity-60"
    ></div>
    <div
    ...
    ></div>
    <div
      class="absolute bottom-1/4 left-1/3 w-2 h-2 bg-blue-500 rounded-full animate-ping opacity-60"
      style="animation-delay: 2s"
    ></div>
...
// Audio control (matching header/hero functionality)

  ...
  <div class="min-h-screen">
    ...
    <div class="bg-white relative" id="forums-content">
                ...
                <div class="relative">
                  <div class="flex items-start justify-between mb-4">
                    <div class="flex items-center space-x-2">
                      ...
                      <span v-if="topic.is_hot" class="inline-flex items-center px-2.5 py-0.5 rounded-full text-xs font-medium bg-red-100 text-red-800">
      ...
      <div class="absolute bottom-0 left-0 w-full transform translate-y-1">
        <svg viewBox="0 0 1200 120" preserveAspectRatio="none" class="w-full h-16">
          <path fill="rgb(248 250 252)" d="M0,120 Q300,80 600,100 T1200,90 L1200,120 Z" />
        </svg>
      </div>
    </div>
  </div>

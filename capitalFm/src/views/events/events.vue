    ...
    <div class="min-h-screen">
      ...
      <section class="relative min-h-[70vh] flex items-center justify-center overflow-hidden" style="margin-top: -5rem !important;">
        ...
        <div class="relative z-10 container mx-auto px-6 text-center">
          ...
          <div class="inline-flex items-center justify-center mb-8">
            ...
            <span class="mx-4 text-[#F8CB00] font-bold tracking-wider text-sm uppercase">Live Events</span>
            <div class="h-px w-12 bg-[#F8CB00]"></div>
          </div>
          ...
          <div class="grid grid-cols-2 md:grid-cols-4 gap-8 mb-12 max-w-4xl mx-auto">
            <div class="text-center">
              <div class="text-3xl md:text-4xl font-bold text-[#F8CB00] mb-2">{{ eventStats.upcoming_events }}</div>
              <div class="text-sm text-gray-300 uppercase tracking-wide">Upcoming Events</div>
            </div>
            <div class="text-center">
              <div class="text-3xl md:text-4xl font-bold text-red-400 mb-2">{{ eventStats.this_month }}</div>
              <div class="text-sm text-gray-300 uppercase tracking-wide">This Month</div>
            </div>
            <div class="text-center">
              <div class="text-3xl md:text-4xl font-bold text-blue-400 mb-2">{{ events?.total || 0 }}</div>
              <div class="text-sm text-gray-300 uppercase tracking-wide">Total Events</div>
            </div>
            <div class="text-center">
              <div class="text-3xl md:text-4xl font-bold text-green-400 mb-2 flex items-center justify-center gap-2">
                ...
                <div v-if="eventStats.featured_events > 0" class="w-3 h-3 bg-green-500 rounded-full animate-pulse"></div>
              </div>
              <div class="text-sm text-gray-300 uppercase tracking-wide">Featured Events</div>
            </div>
          </div>
      ...
      <div class="bg-white relative" id="events-content">
        ...
        <div class="absolute inset-0 overflow-hidden opacity-5 pointer-events-none">
          <div class="absolute top-1/4 left-1/5 w-32 h-32 bg-[#F8CB00] rounded-full blur-2xl animate-float"></div>
          <div class="absolute bottom-1/3 right-1/5 w-40 h-40 bg-red-500 rounded-full blur-3xl animate-float" style="animation-delay: 2s;"></div>
          ...
          <div class="mb-12">
            ...
            <div class="flex flex-wrap justify-center gap-3 mb-8">
              <button
                ...
                :class="quickFilter === 'upcoming' ? 'bg-[#F8CB00] text-black' : 'bg-gray-100 hover:bg-gray-200 text-gray-700'"
              ...
              <button
                ...
                :class="quickFilter === 'this_week' ? 'bg-[#F8CB00] text-black' : 'bg-gray-100 hover:bg-gray-200 text-gray-700'"
                class="px-4 py-2 rounded-lg font-medium transition-colors"
              >
                This Week
              </button>
              <button
                ...
                :class="quickFilter === 'featured' ? 'bg-[#F8CB00] text-black' : 'bg-gray-100 hover:bg-gray-200 text-gray-700'"
                class="px-4 py-2 rounded-lg font-medium transition-colors"
              >
                Featured
              </button>
              <button
                ...
                :class="quickFilter === 'public' ? 'bg-[#F8CB00] text-black' : 'bg-gray-100 hover:bg-gray-200 text-gray-700'"
                class="px-4 py-2 rounded-lg font-medium transition-colors"
              >
                Public Events
              </button>
          ...
          <div v-else-if="eventsData.length > 0">
            ...
            <div v-if="featuredEvents.length > 0" class="mb-12">
              <div class="flex items-center gap-3 mb-8">
                ...
                <div class="flex-1 h-px bg-gradient-to-r from-[#F8CB00] to-transparent"></div>
              </div>
              ...
              <div class="grid grid-cols-1 lg:grid-cols-2 gap-6 mb-8">
                ...
                >
                  ...
                  <div class="absolute -inset-1 bg-gradient-to-r from-[#F8CB00] via-red-500 to-blue-500 rounded-xl blur opacity-0 group-hover:opacity-10 transition duration-300"></div>
                  ...
                  <div class="relative">
                    ...
                    <div class="p-6">
                      <div class="flex items-center gap-2 mb-3">
                        <span class="bg-[#F8CB00]/20 text-[#F8CB00] px-3 py-1 rounded-full text-sm font-medium">
                      ...
                      <h3 class="text-xl font-bold text-gray-900 mb-3 group-hover:text-[#F8CB00] transition-colors line-clamp-2">
                        {{ event.title }}
                      </h3>
            ...
            <div class="space-y-4 mb-8">
              ...
              >
                <!-- Gradient background on hover -->
                <div class="absolute -inset-1 bg-gradient-to-r from-[#F8CB00] via-red-500 to-blue-500 rounded-xl blur opacity-0 group-hover:opacity-5 transition duration-300"></div>
                ...
                <div class="relative">
                  <div class="flex items-start space-x-4">
                    ...
                    <div class="flex-1 min-w-0">
                      ...
                      <h3 class="text-lg font-semibold text-gray-900 mb-2 group-hover:text-[#F8CB00] transition-colors line-clamp-2">
                        {{ event.title }}
                      </h3>

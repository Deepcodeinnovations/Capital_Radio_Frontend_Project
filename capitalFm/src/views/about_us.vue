<template>
  ...
  >
    ...
    <!-- Hero Content -->
    <div class="relative z-10 container mx-auto px-6 py-28 md:py-0 text-center">
      <!-- Hero Badge -->
      ...
      >
        Uganda's premier radio station, delivering fresh hits and quality
        entertainment since 1993
      </p>
